...
@LocalTarget{Target=[Pro01],Text={[Pro01]}}@\Ada Resource Association: Operating Procedures for Ada Conformity Assessments Version 3.0, April 2001
@Shrink{@i{(This can
be found online at @URLLink{URL=[http://www.adaic.org/compilers/testing.html],
Text=[http://www.adaic.org/compilers/testing.html]}.)}}
