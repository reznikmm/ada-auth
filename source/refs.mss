...
@begin{Intro}
@begin{NotIso}
@ChgAdded{Version=[5],Noprefix=[T],Noparanum=[T],Text=[@Shrink{@i<Paragraphs 1
through 7 and 9 through 10 have been moved to the
Bibliography.>}]}@Comment{This message should be
deleted if the paragraphs are ever renumbered.}
@end{NotIso}

@ChgRef{Version=[3],Kind=[Added],ARef=[AI05-0127-2],ARef=[AI05-0299-1]}
@Chg{Version=[3],New=[@Defn{ISO 639-3:2007}
...
@ChgRef{Version=[5],Kind=[DeletedNoDelMsg],ARef=[AI12-0441-1]}
@ChgDeleted{Version=[5],Text=[@Chg{Version=[2],New=[@Defn{ISO/IEC 1539-1:2004}
...
@ChgRef{Version=[2],Kind=[Revised],ARef=[AI95-00415-01]}
@ChgRef{Version=[5],Kind=[DeletedNoDelMsg],ARef=[AI12-0441-1]}
@ChgDeleted{Version=[5],Text=[@Chg{Version=[2],New=[@Defn{ISO 1989:2002}
...
@ChgDeleted{Version=[5],Text=[@Chg{Version=[2],New=[@Defn{ISO 8601:2004}
@Defn{date and time formatting standard}
ISO 8601:2004, @i{Data elements and interchange formats @em Information
interchange @em Representation of dates and times}.],Old=[]}]}

@ChgRef{Version=[3],Kind=[Revised],ARef=[AI05-0299-1]}
@ChgRef{Version=[5],Kind=[DeletedNoDelMsg],ARef=[AI12-0441-1]}
@ChgDeleted{Version=[5],Text=[@Chg{Version=[3],New=[@Defn{ISO/IEC 8859-1:1998}
...
@ChgRef{Version=[5],Kind=[DeletedNoDelMsg],ARef=[AI12-0441-1]}
@ChgDeleted{Version=[5],Text=[@Chg{Version=[2],New=[@Chg{Version=[3],New=[@Defn{ISO/IEC 9899:2011}
...
@ChgRef{Version=[2],Kind=[DeletedAddedNoDelMsg],ARef=[AI95-00285-01]}
...
@ChgRef{Version=[3],Kind=[Revised],ARef=[AI05-0266-1]}
@ChgRef{Version=[5],Kind=[DeletedNoDelMsg],ARef=[AI12-0441-1]}
@ChgDeleted{Version=[5],Text=[@Chg{Version=[2],New=[@Chg{Version=[3],New=[@Defn{ISO/IEC 14882:2011}
...
@i{@Chg{Version=[3],New=[Information technology @em ],Old=[]}Programming languages @em C++}.],Old=[]}]}
@begin{Discussion}
  @ChgRef{Version=[2],Kind=[AddedNormal]}
  @ChgRef{Version=[3],Kind=[DeletedNoDelMsg]}
...
@ChgRef{Version=[5],Kind=[DeletedNoDelMsg],ARef=[AI12-0441-1]}
@ChgDeleted{Version=[5],Text=[@Chg{Version=[2],New=[@Defn{ISO/IEC TR 19769:2004}
...
programming language C to support new character data types}.],Old=[]}]}

@begin{Discussion}
@ChgRef{Version=[5],Kind=[DeletedNoDelMsg],ARef=[AI12-0441-1]}
@ChgDeleted{Version=[5],Text=[@Defn{POSIX}
POSIX,
