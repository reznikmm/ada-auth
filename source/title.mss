...
@comment{$Revision: 1.74 $ $Date: 2017/12/20 04:30:56 $}
...
@Noparanum@Center{@Swiss{@Grow{ISO/IEC 8652:@Chg{Version=[3],New=[@Chg{Version=[5],New=[202x],Old=[2012]}],Old=[1995]}(E)@Chg{Version=[5],New=<, Draft 12>,Old=[]}}}}
