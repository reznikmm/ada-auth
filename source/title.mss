...
@comment{$Revision: 1.84 $ $Date: 2019/09/09 02:53:21 $}
...
@Noparanum@Right{@Swiss{@Grow{@B{Ada Reference Manual}, @Chg{Version=[3],New=[@Chg{Version=[5],New=[202x],Old=[2012]}],Old=[@Chg{Version=[2],New=[2007],Old=[1995]}]} Edition@Chg{Version=[5],New=<, Draft 22>,Old=[]}}}}
@end{NotISO}
...
@Noparanum@Center{@Swiss{@Grow{@Chg{Version=[5],New=[202x],Old=[@Chg{Version=[3],New=[2012],Old=[1995]}]} Edition@Chg{Version=[5],New=<, Draft 22>,Old=[]}}}}
...
@Comment{@Noparanum@Center{@Swiss{@Grow{ISO/IEC 8652:@Chg{Version=[3],New=[@Chg{Version=[5],New=[202x],Old=[2012]}],Old=[1995]}(E)@Chg{Version=[5],New=<, Draft 22>,Old=[]}}}}}
