...
@comment{$Revision: 1.63 $ $Date: 2013/08/17 02:17:38 $}
...
@end{ISOOnly}
@begin{NotISO}
@Noparanum@Right{@Swiss{@Grow{@B{Ada Reference Manual}, ISO/IEC 8652:@Chg{Version=[3],New=[@Chg{Version=[4],New=[202x(E)],Old=[2012(E)]}],Old=[@Chg{Version=[2],New=[2007(E) Ed. 3],Old=[1995(E)@Chg{Version=[1], New=[ with COR.1:2001], Old=[]}]}]}}}}
@end{NotISO}
...
@Noparanum@Center{@Swiss{@Grow{ISO/IEC 8652:@Chg{Version=[3],New=[@Chg{Version=[4],New=[202x],Old=[2012]}],Old=[1995]}(E)@Chg{Version=[4],New=<, Draft 2>,Old=[]}}}}
...
@Noparanum@;@Chg{Version=[3], New=[Copyright @Latin1(169) 2008, 2009, 2010, 2011, 2012@Chg{Version=[4], New=[, 2013],Old=[]}  AXE Consultants], Old=[]}
@end{NotISO}
@begin{ISOOnly}
...
@Noparanum@;@Chg{Version=[4], New=[Copyright @Latin1(169) 2013 AXE Consultants.  All Rights Reserved.], Old=[]}
