...
@comment{$Revision: 1.78 $ $Date: 2019/01/12 03:52:47 $}
...
@Noparanum@Center{@Swiss{@Grow{ISO/IEC 8652:@Chg{Version=[3],New=[@Chg{Version=[5],New=[202x],Old=[2012]}],Old=[1995]}(E)@Chg{Version=[5],New=<, Draft 16>,Old=[]}}}}
